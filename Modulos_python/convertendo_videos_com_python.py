...
-c:s srt -map v:0 -map 1:0 COMANDO PARA CONVERTER SÓ 10s DO VÍDEO(-ss 00:00:00 -to 00:00:10) "SAÍDA"
"""
import os
import fnmatch
import sys
...
if sys.platform == 'linux':
    ...
    # PARA FUNCIONAR NO WINDOWS FOI NECESSÁRIO BAIXAR UM ARQUIVO E COLOCAR NO CAMINHO ESPECIFICADO ACIMA
...
# debug = '' # PARA CONVERTER O VÍDEO COMPLETO
...
for raiz, pastas, arquivos in os.walk(caminho_origem):
    for arquivo in arquivos:
        ...
        comando = f'{comando_ffmpeg} -i "{caminho_destino}" {input_legenda}' \
