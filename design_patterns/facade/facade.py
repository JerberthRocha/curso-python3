...
class WeatherStationFacade:
    def __init__(self) -> None:
        ...
        self.smartphone_1 = Smartphone('Phone_1', self.weather_station)
        self.smartphone_2 = Smartphone('Phone_2', self.weather_station)
...
if __name__ == '__main__':
    ...
    weather_station.change_state({'humidity': '85'})
