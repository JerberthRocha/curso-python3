...
if __name__ == '__main__':
    ...
    joao.broadcast('Boa noite pessoal')
    maria.broadcast('Boa noite. tudo bem?')
    ana.broadcast('Não estou no grupo')
    jose.broadcast('Tudo de boas...')

    print()

    maria.send_direct('José', 'Oi, tudo bem?')
    jose.send_direct('Maria', 'Oi, tudo bem e vc?')
