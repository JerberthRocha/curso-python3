...
class UserDirector:
    ...
    def with_age(self, firstname, lastname, age):
        self._buider.add_firstname(firstname) \
            .add_lastname(lastname) \
            .add_age(age)
        return self._buider.result
...
if __name__ == '__main__':
    ...
    user1 = user_director.with_age('João', 'Souza', 33)
    user2 = user_director.with_address('Carlos', 'Antonio', 'Av Tancredo Neves')
    print(user1)
    print(user2)
